      ...
      return SizedBox(
        ...
        child: ElevatedButton(
          ...
          style: ElevatedButton.styleFrom(
            ...
            side: isSecundario
                ? BorderSide(
                    color: onPressed == null ? const Color(0xFFC9BCBC) : corEscura,
                    width: 1.w)
                : null,
            ...
            disabledBackgroundColor:
                isSecundario ? Colors.transparent : const Color(0xFFC9BCBC),
            disabledForegroundColor:
                isSecundario ? const Color(0xFFC9BCBC) : corTextoClaro,
          ).copyWith(
